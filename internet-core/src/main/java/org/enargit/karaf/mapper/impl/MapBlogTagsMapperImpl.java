...
import org.enargit.karaf.data.dto.MapBlogTagsDto.MapBlogTagsDtoBuilder;
import org.enargit.karaf.data.entities.MapBlogTags;
import org.enargit.karaf.data.entities.MapBlogTags.MapBlogTagsBuilder;
...
public class MapBlogTagsMapperImpl implements MapBlogTagsMapper {
    ...
    public MapBlogTags convertToEntity(MapBlogTagsDto dto) {
        ...
        MapBlogTagsBuilder<?, ?> mapBlogTags = MapBlogTags.builder();
    ...
    public MapBlogTagsDto convertToDTO(MapBlogTags entity) {
        ...
        MapBlogTagsDtoBuilder<?, ?> mapBlogTagsDto = MapBlogTagsDto.builder();
